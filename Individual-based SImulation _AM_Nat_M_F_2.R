...
SDa = 0.964 # additive genetic standard deviation
SDe = 0.816 # environmental standard deviation
SDs = 0.698 # segregational standard deviation
sex = 1 # genetic factor causing sexual dimorphism
eta = 0.2 # strength of habitat preference
m = 0.286  # max prob of migration
theta_pine = 25.2 # ecological optimum in pine
theta_oak = 23.5 # ecological optimum in oak
gamma = 0.01 # strength of selection
...
p <- p + annotate("rect", xmin = -Inf, xmax = Inf,ymin = 22.53915, ymax = 22.86291, alpha = .15) + 
          annotate("rect", xmin = -Inf, xmax = Inf,ymin = 24.62476, ymax = 24.93638, alpha = .15)+
          annotate("rect", xmin = -Inf, xmax = Inf,ymin = 23.22039, ymax = 23.77606, alpha = .15)+
         annotate("rect", xmin = -Inf, xmax = Inf,ymin = 25.33897, ymax = 25.8095, alpha = .15)
...
p <- p + geom_line(aes(y = Zbar_oak_F, color="Zbar_oak_F")) + labs(color = "") + 
  scale_color_manual(values = colors, labels = c("Pine Male", "Pine Female", "Oak Male", "Oak Female"))+ 
...
B <- B + annotate("rect", xmin = -Inf, xmax = Inf, ymin = 1.159414, ymax = 1.467943, alpha = .15)
...
B <- B + scale_x_continuous() + scale_y_continuous(name = "$\\sigma^2_{pooled}$", breaks = seq(1,2,0.1), limits = c(1.0,2.0))
plot(B)
